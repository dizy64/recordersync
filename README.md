...
--partial                     기본 부분 구간 분석을 명시적으로 유지(호환 옵션)
--full-only                   analyze에서 부분 탐색을 생략
...
- [제품 컨셉](docs/product/concept.md)
- [아키텍처와 알고리즘](docs/design/architecture.md)
